...
# FULL MODEL
row_names = list("Intercept", "layup", "dunk", "hook", "fadeaway", "pullup", "running", "driving", "reverse", "fingerroll", "putback", "turnaround", "bank", "point_diff", "tip", "TOUCH_TIME", "DRIBBLES", "ratio", "jump_shot", "End_SC", "End_PC", "LOCATION", "Quick_S", "Clutch_T", "Garbage_T", "SHOT_CLOCK", "SHOT_NUMBER")
...
for(i in 1:nrow(fixed_effects)) {
  row.names(fixed_effects)[i] = fixed_effect_row_names[[i]]
}
