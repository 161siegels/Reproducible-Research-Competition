...
final$point_diff=ifelse(final$EVENTMSGTYPE==1&final$LOCATION=="A",final$point_diff+final$PTS_TYPE,final$point_diff)
```
...
data$End_PC <- ifelse(data$GAME_CLOCK2 > 40, 0,1)
